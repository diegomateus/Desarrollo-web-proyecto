...
public class QuestionAnsweredDomainEvent extends DomainEvent{
    ...
    public QuestionAnsweredDomainEvent(){
        super(null);
    ...
    public QuestionAnsweredDomainEvent(String aggregateId, String propertyId, String text, LocalDate date, String answer) {
        super(aggregateId);
    ...
    public QuestionAnsweredDomainEvent(String aggregateId, String eventId, String occurredOn, String propertyId, String text, LocalDate date, String answer) {
    ...
    public DomainEvent fromPrimitive(String aggregateId, HashMap<String, Serializable> body, String eventId, String occurredOn) {
        return new QuestionAnsweredDomainEvent(aggregateId,eventId,occurredOn,
    ...
    public boolean equals(Object o){
        ...
        QuestionAnsweredDomainEvent that = (QuestionAnsweredDomainEvent) o;
