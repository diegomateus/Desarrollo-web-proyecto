...
public class PropertyTest {
    ...
    void should_create_property(){
        ...
        creator.execute("bb5f8ac3-b90d-40ec-b3e2-e0ca3f432721","calle 100",PropertyTypeEnum.APARTAMENTO,"bogota","es grande",3,2,1000,100,3,PropertyConditionEnum.NUEVO,new GregorianCalendar(2021,5,11),(long)1.12345678,(long)1.12345678,null,null,null);
        verify(repository,atLeastOnce()).save(actualProperty);
    }

    @Test
    void should_find_property(){
        Property actualProperty = new Property(new PropertyId("bb5f8ac3-b90d-40ec-b3e2-e0ca3f432721"),new Address("calle 100"),new PropertyType(PropertyTypeEnum.APARTAMENTO),new City("bogota"),new Description("es grande"),new BedroomsNumber(3),new BathroomsNumber(2),new PrivateArea(1000),new BuiltArea(100),new ServiceLevel(3), new Condition(PropertyConditionEnum.NUEVO),new DeliveryDate(new GregorianCalendar(2021,5,11)),new Location((long)1.122323,(long)1.12232323),null,null,null);
        PropertyRepository repository = mock(PropertyRepository.class);
    ...
    void should_update_property(){
        ...
        modifier.execute("bb5f8ac3-b90d-40ec-b3e2-e0ca3f432721", "calle 105",PropertyTypeEnum.APARTAMENTO,"Medellin","es grande",3,2,1000,100,3, PropertyConditionEnum.NUEVO, new GregorianCalendar(2021,5,11),(long)1.12345678,(long)1.12345678,null,null,null);
